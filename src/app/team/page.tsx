...
const teamMembers = [
  ...
  },
  {
    name: "Mudassir",
    role: "Lead Bidder",
    image: null, // Aap apni image path yahan add kar sakti hain
    bio: "Strategic business analyst expert in analyzing project requirements, client communication, and securing high-value technical contracts.",
    skills: ["Bidding Strategy", "Client Relations", "Proposal Writing", "Upwork/LinkedIn"],
    featured: false,
  },
  {
    name: "Mussafa",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {teamMembers.filter((m) => m.featured).map((member, index) => (
            <motion.div
              ...
              className="bg-[rgba(183,132,96,0.05)] border border-[rgba(183,132,96,0.2)] rounded-3xl p-8 md:p-12 backdrop-blur-sm relative"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {teamMembers.filter((m) => !m.featured).map((member, index) => (
              <motion.div
                ...
                className="h-full"
              >
                <Card className="glass-card bg-[#141414] border-[#2A2420] hover:border-[rgba(183,132,96,0.35)] transition-all duration-300 group backdrop-blur-sm overflow-hidden rounded-3xl h-full flex flex-col justify-between">
